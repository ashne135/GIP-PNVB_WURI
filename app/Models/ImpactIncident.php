...
/**
 * Section E : impact constaté, cases à cocher multiples
 *
 ...
 * l'architecture.
 */
class ImpactIncident extends Model
{
    protected $table = 'impacts_incident';
    ...
    public function incidents(): BelongsToMany
    {
        ...
        return $this->belongsToMany(Incident::class, 'incident_impact', 'impact_incident_id', 'incident_id');
    }
